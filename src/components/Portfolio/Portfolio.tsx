    ...
    <Container id="portfolio">
      ...
      <ScrollAnimation animateIn="flipInX">
        <div className="project">
          ...
          <div className="body">
            <h3>FCallendar</h3>
            <p>A mobile application made during the Hackathon of the training program of <a href="https://www.fcamara.com.br/"> FCamara</a>. Esta aplicação serve para ajudar na volta do trabalho remoto para o presencial.
            </p>
          </div>
          <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>A nice version to view your GitHub profile, includes data visualization, repositories, sharing and more.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
